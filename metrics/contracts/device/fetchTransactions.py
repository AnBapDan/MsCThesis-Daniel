...
def fetchTx():
    ...
    first = '/api/v1/transactions?account.id=0.0.4551131&timestamp=gte:1697796863.587033063'
    #first = '/api/v1/transactions?account.id=0.0.4551481&timestamp=gte:1697796869.092427962'
